...
import { ANGRY_BURGER_FESTIVAL_LINEUP, ArtistData } from '@/data/AngryBurgerFestival'; 
import { Footer } from '@/components/Footer';

const AngryBurgerFestivalPage = () => {
  const navigate = useNavigate();
  const [artists] = useState<ArtistData[]>(ANGRY_BURGER_FESTIVAL_LINEUP);
  ...
  const handleGenerate = () => {
    ...
    const playlistData = {
      playlistName: `Angry Burger Festival 2026 - My Selection`,
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-28 sm:pt-32 pb-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl sm:text-6xl font-black italic uppercase tracking-tighter mb-4 text-white drop-shadow-lg">
            FESTIVAL <br/>
            <span className="text-[#4d94ff]">ANGRY BURGER</span>
          </h1>
          <p className="text-lg text-gray-300 font-medium mb-4">
            7 - 9 Août 2026 • Auxi-le-Château
          </p>
...
export default AngryBurgerFestivalPage;
