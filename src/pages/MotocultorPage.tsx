...
import { MOTOCULTOR_LINEUP, ArtistData } from '@/data/motocultorData';
import { Footer } from '@/components/Footer';

const MotocultorPage = () => {
  const navigate = useNavigate();
  const [artists] = useState<ArtistData[]>(MOTOCULTOR_LINEUP);
  ...
  const handleGenerate = () => {
    ...
    const selectedArray = artists
      ...
      .map(a => ({
        id: a.id,
        artist: a.name,
        eventDate: a.day + " - Motocultor Festival 2026"
      }));
