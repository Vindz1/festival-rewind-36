...
import { ROCK_EN_SEINE_LINEUP, ArtistData } from '@/data/RockEnSeine'; 
import { Footer } from '@/components/Footer';

const RockEnSeinePage = () => {
  const navigate = useNavigate();
  const [artists] = useState<ArtistData[]>(ROCK_EN_SEINE_LINEUP);
  ...
  const handleGenerate = () => {
    ...
    const playlistData = {
      playlistName: `Rock en Seine 2026 - My Selection`,
      mainArtist: 'Rock en Seine',
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-28 sm:pt-32 pb-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl sm:text-6xl font-black italic uppercase tracking-tighter mb-4 text-white drop-shadow-lg">
            FESTIVAL <br/>
            <span className="text-[#4d94ff]">ROCK EN SEINE</span>
          </h1>
          <p className="text-lg text-gray-300 font-medium mb-4">
            26 - 30 Août 2026 • Domaine National de Saint-Cloud
          </p>

          <a 
            href="https://www.rockenseine.com/" 
            target="_blank" 
...
export default RockEnSeinePage;
