...
import { ON_NA_PLUS_20_ANS_LINEUP, ArtistData } from '@/data/OnNaPlus20Ans'; 
import { Footer } from '@/components/Footer';

const OnNaPlus20AnsPage = () => {
  const navigate = useNavigate();
  const [artists] = useState<ArtistData[]>(ON_NA_PLUS_20_ANS_LINEUP);
  ...
  const handleGenerate = () => {
    ...
    const playlistData = {
      playlistName: `On N'a Plus 20 Ans 2026 - My Selection`,
      mainArtist: `On N'a Plus 20 Ans`,
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-28 sm:pt-32 pb-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl sm:text-6xl font-black italic uppercase tracking-tighter mb-4 text-white drop-shadow-lg">
            FESTIVAL <br/>
            <span className="text-[#4d94ff]">ON N'A PLUS 20 ANS</span>
          </h1>
          <p className="text-lg text-gray-300 font-medium mb-4">
            3 - 5 Avril 2026 • Espace René-Cassin (Fontenay-le-Comte)
          </p>

          <a 
            href="https://www.facebook.com/festivalonnaplus20ans/" 
            target="_blank" 
...
export default OnNaPlus20AnsPage;
