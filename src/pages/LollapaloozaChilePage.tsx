...
// Import correct depuis le nouveau fichier data
import { LOLLAPALOOZA_CHILE_LINEUP, ArtistData } from '@/data/lollapaloozaChileData';
import { Footer } from '@/components/Footer';

const LollapaloozaChilePage = () => {
  const navigate = useNavigate();
  const [artists] = useState<ArtistData[]>(LOLLAPALOOZA_CHILE_LINEUP);
  ...
  const handleGenerate = () => {
    ...
    const selectedArray = artists
      ...
      .map(a => ({
        id: a.id,
        artist: a.name,
        eventDate: a.day + " - Lollapalooza Chile 2026"
      }));
...
export default LollapaloozaChilePage;
