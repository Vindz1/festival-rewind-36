...
const GraspopPage = () => {
  ...
  const [artists] = useState<ArtistData[]>(GRASPOP_LINEUP);
  ...
  const handleGenerate = () => {
    ...
    const selectedArray = artists
      ...
      .map(a => ({
        id: a.id,
        artist: a.name,
        eventDate: a.day + " - Graspop Metal Meeting 2026"
      }));
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <main className="pt-20 pb-20 sm:pb-16 max-w-[1400px] mx-auto px-4">
        <div className="bg-[#2d2d2d] border border-[#4d94ff] rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-[#4d94ff] mb-2 uppercase">
          ...
          >
            <span className="flex items-center gap-2">
              ...
              {(selectedDays.size > 0 || selectedStages.size > 0) && (
                <span className="bg-[#4d94ff] text-white text-xs px-2 py-0.5 rounded-full font-bold">
          ...
          `}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2 text-white font-bold">
                <Filter className="w-5 h-5 text-[#4d94ff]" />
                Filtres
              </div>
              {(selectedDays.size > 0 || selectedStages.size > 0) && (
                <button 
                  ...
                  className="text-xs text-[#4d94ff] hover:text-[#6ba6ff] font-medium"
                >
                  Réinitialiser
                </button>
              )}
                ...
                {availableDays.map(day => (
                  <label key={day} className="flex items-center gap-3 cursor-pointer group">
                    <Checkbox 
                      ...
                      className="border-[#666] data-[state=checked]:bg-[#4d94ff] data-[state=checked]:border-[#4d94ff] data-[state=checked]:text-white"
                    />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                ...
                {selectedArtists.size > 0 && (
                  <p className="text-sm text-[#4d94ff] mt-1 font-medium">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button 
                  ...
                  className="flex-1 sm:flex-none h-9 text-xs bg-[#4d94ff] hover:bg-[#6ba6ff] text-white font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                return (
                  ...
                  >
                    <div className={`
                      ...
                      ${isSelected ? 'bg-[#4d94ff] border-[#4d94ff]' : 'border-[#666] bg-[#2d2d2d]'}
                    `}>
