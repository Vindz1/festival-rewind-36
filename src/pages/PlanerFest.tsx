...
import { PLANER_FEST_LINEUP, ArtistData } from '@/data/PlanerFest'; 
import { Footer } from '@/components/Footer';

const PlanerFestPage = () => {
  const navigate = useNavigate();
  const [artists] = useState<ArtistData[]>(PLANER_FEST_LINEUP);
  ...
  const handleGenerate = () => {
    ...
    const playlistData = {
      playlistName: `Plane'R Fest 2026 - My Selection`,
      mainArtist: `Plane'R Fest`,
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-28 sm:pt-32 pb-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl sm:text-6xl font-black italic uppercase tracking-tighter mb-4 text-white drop-shadow-lg">
            FESTIVAL <br/>
            <span className="text-[#4d94ff]">PLANE'R FEST</span>
          </h1>
          <p className="text-lg text-gray-300 font-medium mb-4">
            3 - 4 Juillet 2026 • Colombier-Saugnieu (Montcul)
          </p>

          <a 
            href="https://www.planerfest.com/" 
            target="_blank" 
