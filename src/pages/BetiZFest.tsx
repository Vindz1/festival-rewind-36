...
import { BETIZFEST_LINEUP, ArtistData } from '@/data/BetiZFest'; 
import { Footer } from '@/components/Footer';

const BetiZFestPage = () => {
  const navigate = useNavigate();
  const [artists] = useState<ArtistData[]>(BETIZFEST_LINEUP);
  ...
  const handleGenerate = () => {
    ...
    const playlistData = {
      playlistName: `BetiZFest 2026 - My Selection`,
      mainArtist: `BetiZFest`,
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-28 sm:pt-32 pb-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl sm:text-6xl font-black italic uppercase tracking-tighter mb-4 text-white drop-shadow-lg">
            FESTIVAL <br/>
            <span className="text-[#4d94ff]">BETIZFEST</span>
          </h1>
          <p className="text-lg text-gray-300 font-medium mb-4">
            9 - 11 Avril 2026 • Palais des Grottes (Cambrai)
          </p>

          <a 
            href="https://betizfest.info/" 
            target="_blank" 
